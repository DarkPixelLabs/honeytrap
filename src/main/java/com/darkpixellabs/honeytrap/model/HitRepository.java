...
import org.springframework.data.domain.*; import org.springframework.data.jpa.repository.*; import org.springframework.data.repository.query.Param; import java.time.Instant; import java.util.*;
public interface HitRepository extends JpaRepository<Hit,Long> {
 ...
 Page<Hit> findAllByOrderByTimestampDesc(Pageable pageable);
